...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <p class="mb-2">
                Ce guide explique comment utiliser l'application au quotidien, étape par
                étape. Certaines sections (marquées <span class="badge text-bg-secondary">Gérant / Superadmin</span>)
                ne concernent que les responsables du magasin — un caissier ne les
                verra pas forcément accessibles depuis son compte, c'est normal.
            </p>
            ...
            <div id="gConnexion" class="accordion-collapse collapse show" data-bs-parent="#accordionGuide">
                <div class="accordion-body">
                    ...
                    <p class="mb-0">
                        ...
                        (voir <a href="#administration">Administration</a>).
                    </p>
                </div>
            </div>
        </div>
            ...
            <div id="gClients" class="accordion-collapse collapse" data-bs-parent="#accordionGuide">
                <div class="accordion-body">
                    ...
                    <p class="mb-0">
                        ...
                        déduire d'un futur achat) — réservé aux utilisateurs habilités.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div id="gCatalogue" class="accordion-collapse collapse" data-bs-parent="#accordionGuide">
                <div class="accordion-body">
                    ...
                    <p>
                        ...
                        transferts, ajustements, casse, retours. <strong>Stock → Mouvements</strong>
                    ...
                    <h6>Inventaire</h6>
                    <p class="mb-0">
                        <strong>Stock → Inventaires</strong> : créer un inventaire pour un magasin,
                        saisir les quantités réellement comptées ; l'écart avec le stock
                        théorique est calculé automatiquement. Il doit être <strong>validé</strong>
                        pour que les ajustements correspondants soient appliqués au stock.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item" id="achats">
            ...
            <div id="gAchats" class="accordion-collapse collapse" data-bs-parent="#accordionGuide">
                <div class="accordion-body">
                    ...
                    <ol>
                        <li>Menu <strong>Achats → Commandes → Nouvelle commande</strong>, choisir le
        ...
        <div class="accordion-item" id="tresorerie">
            <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#gTresorerie">
                    ...
                    <span class="badge text-bg-secondary ms-2">Gérant / Superadmin</span>
                </button>
            </h2>
