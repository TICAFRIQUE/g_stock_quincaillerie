...
return [
    ...
    */
    ...
    'custom' => [
        'magasin_source_id' => [
            'different' => 'Le magasin source et le magasin destination doivent être différents.',
        ],
        'role' => [
            'not_in' => 'Le rôle Superadmin ne peut pas être attribué depuis cet écran.',
        ],
        'lignes.*.produit_id' => [
            'distinct' => 'Ce produit est sélectionné sur plusieurs lignes : regroupez-le sur une seule ligne.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace le nom technique du champ (souvent en anglais ou snake_case)
    | par son libellé métier en français dans les messages ci-dessus.
    |
    */
    ...
    'attributes' => [
        'nom' => 'nom',
        'sku' => 'SKU',
        'libelle_distinctif' => 'libellé distinctif',
        'code_barre' => 'code-barres',
        'categorie_id' => 'catégorie',
        'parent_id' => 'catégorie parente',
        'prix_piece' => 'prix pièce',
        'seuil_alerte' => 'seuil d\'alerte',
        'actif' => 'statut actif',
        'image' => 'image',
        'unites_vente' => 'unités de vente',
        'facteur' => 'facteur',
        'prix' => 'prix',
        'adresse' => 'adresse',
        'telephone' => 'téléphone',
        ...
        'magasin_destination_id' => 'magasin destination',
        'date_commande' => 'date de commande',
        'date' => 'date',
        'lignes' => 'lignes',
        'produit_id' => 'produit',
        'quantite' => 'quantité',
        'quantite_comptee' => 'quantité comptée',
        'type' => 'type',
        'direction' => 'sens du mouvement',
        'motif' => 'motif',
        'permissions' => 'permissions',
        'role' => 'rôle',
        'remise_totale_type' => 'type de remise',
        'remise_totale_valeur' => 'valeur de la remise',
        'paiements' => 'paiements',
        'moyen_paiement_id' => 'moyen de paiement',
        'montant' => 'montant',
        'libelle' => 'libellé',
        'fond_de_caisse' => 'fond de caisse',
        'montant_compte' => 'montant compté',
    ],
